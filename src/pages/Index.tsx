      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 py-12 md:py-16">
          <div className="text-center space-y-6 max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-display font-bold text-emerald-800 animate-bounce-gentle animate-scale-in">
              Lêr + Conta Mundo
            </h1>
            <p className="text-lg md:text-xl font-body text-emerald-800 max-w-2xl mx-auto">
